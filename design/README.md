...
- [0039](adr/0039-cli-first-mode-aware-builds.md) CLI-first builds: `sc` is the only build interface; freshness is mode-aware
...
- [0048](adr/0048-listening-sessions-never-drive-the-harness.md) A listening session transcribes locally and feeds a headless reviewer, never the interactive harness; roles are generic, briefs carry the matter
