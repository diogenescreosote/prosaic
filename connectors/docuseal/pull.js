#!/usr/bin/env node
//
// docuseal connector — thin relay to the Python e-sign client's `poll`.
//
// The connector contract (docs/connectors.md) is Node printing
// "NEW <abs path>" lines; the DocuSeal workflow already lives in
// docuseal-client/client.py with its SDK, receipts, and tests. Spawning it
...
const client = path.join(__dirname, '..', '..', 'docuseal-client', 'client.py');
